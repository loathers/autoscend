...
boolean haveFreeRestAvailable();		//Defined in sl_ascend/sl_util.ash
boolean doFreeRest();										//Defined in sl_ascend/sl_util.ash
...
void equipOverrides(); //Defined in sl_ascend/sl_equipment.ash
