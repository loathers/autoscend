...
void LX_handleIntroAdventures()
{
	...
	if (handling_choice())
	{
		...
		if ($ints[1046, 1405, 1416, 1419, 1446, 1450, 1464, 1480, 1503, 1507, 1519, 1531, 1552, 1559, 1564] contains choice)
		{
			...
			// 1564 is "Under the Sea", intro for 11,037 Leagues Under the Sea (Fall 2025 challenge path).
