...
{
	if(!in_koe() && auto_have_familiar($familiar[Machine Elf]) && (get_property("_machineTunnelsAdv").to_int() < 5) && (my_adventures() > 10) && !autoForbidFamiliarChange() && ($location[The Deep Machine Tunnels].turns_spent == 5) && (my_daycount() == 2))
	{
